...
def contact_page():
    ...
    myButton = tk.Button(contact_frame, text="Enter Schedule",command= lambda:[QuickSort(scheduledata), texts.delete("1.0","end"), C1(e),add_date(word[0],scheduletexts), create_schedule(scheduletext, texts)])
    myButton.pack()
